...
KEYS: dict[str, str] = {
    ...
    "lr_parcel_id": pgettext("key", "lr_parcel_id"),
    ...
    "total_possessors": pgettext("key", "total_possessors"),
    ...
    "parcel_number_display": pgettext("key", "parcel_number_display"),
    "is_building_parcel": pgettext("key", "is_building_parcel"),
    "part_type": pgettext("key", "part_type"),
    "building_right": pgettext("key", "building_right"),
    ...
    "possessors_in_land_registry": pgettext("key", "possessors_in_land_registry"),
    ...
    "condominium_units": pgettext("key", "condominium_units"),
    "encumbrances": pgettext("key", "encumbrances"),
    "has_sheet_c_entries": pgettext("key", "has_sheet_c_entries"),
    ...
    "entry": pgettext("key", "entry"),
    "share_entries": pgettext("key", "share_entries"),
    "priority_diary_number": pgettext("key", "priority_diary_number"),
    "transferred_from_unit": pgettext("key", "transferred_from_unit"),
    "description_text": pgettext("key", "description_text"),
    "style_class": pgettext("key", "style_class"),
    "amount": pgettext("key", "amount"),
    "amount_value": pgettext("key", "amount_value"),
    "amount_currency": pgettext("key", "amount_currency"),
    "source_key": pgettext("key", "source_key"),
    "court_name": pgettext("key", "court_name"),
    "book_id": pgettext("key", "book_id"),
    "book_name": pgettext("key", "book_name"),
    ...
    "plumb_mark": pgettext("key", "plumb_mark"),
    ...
    "parcel_area_m2": pgettext("key", "parcel_area_m2"),
    "in_building_area": pgettext("key", "in_building_area"),
    "matches": pgettext("key", "matches"),
    "zone": pgettext("key", "zone"),
    "zones": pgettext("key", "zones"),
    "feature_id": pgettext("key", "feature_id"),
    "zone_kind": pgettext("key", "zone_kind"),
    "generation": pgettext("key", "generation"),
    "designation_code": pgettext("key", "designation_code"),
    "designation": pgettext("key", "designation"),
    "designation_detail": pgettext("key", "designation_detail"),
    "designation_class": pgettext("key", "designation_class"),
    "zone_name": pgettext("key", "zone_name"),
    "plan_name": pgettext("key", "plan_name"),
    "plan_id": pgettext("key", "plan_id"),
    "county_code": pgettext("key", "county_code"),
    "source_sheet": pgettext("key", "source_sheet"),
    "source_scale": pgettext("key", "source_scale"),
    "polygons": pgettext("key", "polygons"),
    "overlap_fraction": pgettext("key", "overlap_fraction"),
    "overlap_m2": pgettext("key", "overlap_m2"),
    "plans": pgettext("key", "plans"),
    "dataset": pgettext("key", "dataset"),
    "state": pgettext("key", "state"),
    "source_url": pgettext("key", "source_url"),
    "disclaimer": pgettext("key", "disclaimer"),
    "buildability": pgettext("key", "buildability"),
    "below_threshold": pgettext("key", "below_threshold"),
    "intersecting_zones": pgettext("key", "intersecting_zones"),
    "min_overlap": pgettext("key", "min_overlap"),
