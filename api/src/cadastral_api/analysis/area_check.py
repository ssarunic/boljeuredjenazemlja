...
class AreaCheck(BaseModel):
    ...
    mismatch: bool = Field(description="True when the largest difference exceeds the tolerance")
...
def check_area(
    ...
    False and the note says so. Non-positive values count as unknown.
    """
    ...
    return AreaCheck(
        ...
        mismatch=fraction is not None and fraction > tolerance,
        note=note,
    )
