...
1122/1) has two real active plombe.
"""
...
def test_active_plumbs_are_typed() -> None:
    ...
    assert {p.file_number for p in unit.active_plumbs} == {"Z-12564/2026", "Z-18444/2026"}
...
def test_summary_surfaces_pending_plombe() -> None:
    ...
    assert summary["pending_plombe"] == ["Z-12564/2026", "Z-18444/2026"]
